...
function About() {
  return (
    <div className='w-full my-20 flex flex-col gap-6'>
        ...
        <div className='w-full flex items-center justify-center gap-10 max-lg:flex-col'>
            <div className='h-1/3 w-1/4 my-8 items-center max-lg:w-1/2 max-md:w-1/3'>
                <img src={aboutImg} className='items-center self-center rounded-2xl shadow-lg shadow-blue-900'></img>
            </div>

            <div className='h-1/2 w-1/3 flex flex-col gap-8 items-center text-2xl leading-relaxed max-lg:w-1/2 max-sm:w-2/3'>
