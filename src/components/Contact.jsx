...
function Contact() {
  return (
    <div className='w-full px-16 my-28 flex flex-col text-center'>
        ...
        <div className='py-10 flex justify-center gap-16 max-lg:flex-col items-center'>

            <div className='w-1/4 py-6 flex flex-col gap-4 rounded-2xl border-2 hover:bg-white transition ease-in-out delay-75 duration-300 hover:text-blue-500 hover:scale-110 max-lg:w-full'>
